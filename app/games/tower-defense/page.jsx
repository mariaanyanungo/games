...
// If you claimed "Tower Defense", replace everything in this file with your game.
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between gap-2">
            <CardTitle>Tower Defense</CardTitle>
            <Badge variant="secondary">hard</Badge>
          </div>
        </CardHeader>
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">{"Place towers to stop waves of enemies."}</p>
